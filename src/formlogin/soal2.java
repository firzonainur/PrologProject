...
public class soal2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Berapakah nilai terakhir dari 1, 2, 3, 4, 5?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String s4 = "(findLast(X,[1,2,3,4,5]))";
        Query q4 = new Query(s4);
        System.out.println("First Child of " +s4+" : x = " +(q4.oneSolution().get("X")));

        jLabel3.setText(String.valueOf("Jawaban benar = " +(q4.oneSolution().get("X"))));
