...
public class soal3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Berapakah nilai pertama dari 2, 1, 5, 7?");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String s6 = "(findFirst(X,[2,1,5,7]))";
        Query q6 = new Query(s6);
        System.out.println("First Child of " +s6+" : x = " +(q6.oneSolution().get("X")));
        
        jLabel3.setText(String.valueOf("Jawaban benar = " +(q6.oneSolution().get("X"))));
